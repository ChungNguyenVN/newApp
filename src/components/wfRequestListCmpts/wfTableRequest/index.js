...
function TableHeadRequest(props) {
...
export default function WFTableRequest(props) {
              ...
              {props.dataSources
                ...
                .map((row, index) => (
                  <TableRow key={index}>
                    ...
                    {props.dataColumns.map((item, keyItem) => (
                      <TableCell key={keyItem}>
                        {" "}
                        {row[item.FieldName]}{" "}
                      </TableCell>
                    ))}
